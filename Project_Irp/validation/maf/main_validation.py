...
Usage:
    python -m validation.maf.main_validation                        # NSGA-III, 30 runs, 4 objectives
    python -m validation.maf.main_validation --algorithm qinsga3    # QINSGA3, 30 runs, 4 objectives
...
from validation.maf import maf_problems
